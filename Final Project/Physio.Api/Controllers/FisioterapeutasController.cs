...
namespace Physio.Api.Controllers
{
    ...
    public class FisioterapeutasController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<FisioterapeutaDto>>> GetAll()
        {
        ...
        [HttpGet("{id:int}")]
        public async Task<ActionResult<FisioterapeutaDto>> GetById(int id)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<FisioterapeutaDto>> Create(FisioterapeutaDto dto)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<IActionResult> Update(int id, FisioterapeutaDto dto)
        {
